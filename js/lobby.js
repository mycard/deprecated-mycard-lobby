...
(function() {
  var cards_search, default_room_names, gui, login, maximized, mycard_client, mycard_client_connect, mycard_version, pre_load_photo, room_template, rooms_connect, set_status, win, ygopro_version, _i, _results;
  ...
  $.getJSON("http://my-card.in/cards_zh.json?f={'name':1,'_id':0}", function(data) {
  ...
  $('#new_room_quick_single').click(function() {
    var room_name;

    room_name = mycard.room_name($('#newroom_quick_name').text());
    return mycard_client.send(mycard.room_url_mycard("122.0.65.70", 7911, room_name, "zh99998", "zh112998", false, false));
  });

  $('#new_room_quick_match').click(function() {
    var room_name;
  ...
  $('#new_room_quick_tag').click(function() {
    var room_name;
  ...
  $.getJSON('https://api.github.com/repos/mycard/mycard/issues', function(data) {
    var element, issue, label, labels, _j, _k, _len, _len1, _ref, _results1;
    ...
    for (_j = 0, _len = data.length; _j < _len; _j++) {
      ...
      _results1.push(element.appendTo('#issues'));
    }
    return _results1;
  });
  ...
  rooms_connect = function() {
    ...
    connected = false;
    $('#new_room_quick').nextAll().replaceWith($('<p/>', {
      text: '正在连接...'
    }));
    ...
    websocket.onmessage = function(evt) {
      var element, player, room, rooms, _j, _k, _len, _len1, _ref;
      ...
      if (connected) {
        for (_j = 0, _len = rooms.length; _j < _len; _j++) {
          room = rooms[_j];
          if (room._deleted) {
            $("#room_" + room.id).hide('slow', function() {});
        ...
        $('#new_room_quick').nextAll().replaceWith((function() {
          var _l, _len2, _len3, _m, _ref1, _results1;

          _results1 = [];
          for (_l = 0, _len2 = rooms.length; _l < _len2; _l++) {
            room = rooms[_l];
            room = $.extend({
              rule: 0,
              mode: 0,
            ...
            _results1.push(room_template.render(room));
          }
          return _results1;
        })());
      }
