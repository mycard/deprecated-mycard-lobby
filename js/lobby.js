...
(function() {
  var cards_search, default_room_names, gui, login, maximized, mycard_client, mycard_client_connect, mycard_version, pre_load_photo, render_room, room_template, rooms_connect, servers, set_status, win, ygopro_version, _i, _results;
  ...
  */
  ...
  $('#rooms').on('click', '.room.wait', function(event) {
    ...
    return mycard_client.send(mycard.room_url_mycard(server.ip, server.port, $(this).data('origin-name'), $.cookie('username'), $.cookie('password'), false, false));
  });
