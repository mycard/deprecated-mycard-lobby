...
Candy.View.Translation = {
	...
	'de' : {
		...
		'presenceUnknownWarning'       : 'Dieser Benutzer k?nnte bereits abgemeldet sein. Wir k?nnen seine Anwesenheit nicht verfolgen.',
		...
		'nicknameConflict': 'Der Benutzername wird bereits verwendet. Bitte w?hle einen anderen.',
	...
	'es': {
		...
		'presenceUnknownWarning'       : '?ste usuario podría estar desconectado..',
		...
		'enterRoomPassword' : 'La sala "%s" está protegida mediante contrase?a.',
		'enterRoomPasswordSubmit' : 'Unirse a la sala',
		'passwordEnteredInvalid' : 'Contrase?a incorrecta para la sala "%s".',
	...
	'sv' : {
		...
		'statusDisconnecting': 'Kopplar fr?n...',
		'statusDisconnected' : 'Fr?nkopplad',
		'statusAuthfail': 'Autentisering misslyckades',

		'roomSubject'  : '?mne:',
		'messageSubmit': 'Skicka',

		'labelUsername': 'Anv?ndarnamn:',
		'labelPassword': 'L?senord:',
		...
		'youHaveBeenKickedBy'   : 'Du har blivit utsparkad fr?n %2$s av %1$s',
		'youHaveBeenKicked'     : 'Du har blivit utsparkad fr?n %s',
		'banActionLabel'        : 'Bannlys',
		'youHaveBeenBannedBy'   : 'Du har blivit bannlyst fr?n %1$s av %2$s',
		'youHaveBeenBanned'     : 'Du har blivit bannlyst fr?n %s',
		...
		'administratorMessageSubject' : 'Administrat?r',

		'userJoinedRoom'           : '%s kom in i rummet.',
		'userLeftRoom'             : '%s har l?mnat rummet.',
		'userHasBeenKickedFromRoom': '%s har blivit utsparkad ur rummet.',
		'userHasBeenBannedFromRoom': '%s har blivit bannlyst fr?n rummet.',

		'presenceUnknownWarningSubject': 'Notera:',
		'presenceUnknownWarning'       : 'Denna anv?ndare kan vara offline. Vi kan inte f?lja dennes n?rvaro.',

		'dateFormat': 'yyyy-mm-dd',
		'timeFormat': 'HH:MM:ss',

		'tooltipRole'           : 'Moderator',
		'tooltipIgnored'        : 'Du blockerar denna anv?ndare',
		...
		'tooltipUsercount'      : 'Antal anv?ndare i rummet',

		'enterRoomPassword' : 'Rummet "%s" ?r l?senordsskyddat.',
		'enterRoomPasswordSubmit' : 'Anslut till rum',
		'passwordEnteredInvalid' : 'Ogiltigt l?senord f?r rummet "%s".',

		'nicknameConflict': 'Upptaget anv?ndarnamn. Var god v?lj ett annat.',

		'errorMembersOnly': 'Du kan inte ansluta till rummet "%s": Otillr?ckliga r?ttigheter.',
		'errorMaxOccupantsReached': 'Du kan inte ansluta till rummet "%s": Rummet ?r fullt.',

		'antiSpamMessage' : 'Var god avst? fr?n att spamma. Du har blivit blockerad f?r en kort stund.'
	},
	'it' : {
		'status': 'Stato: %s',
	...
	'pt': {
		...
		'statusAuthfail': 'Falha na autentica??o',
		...
		'ignoreActionLabel'  : 'Ignorar',
		'unignoreActionLabel' : 'N?o ignorar',
		...
		'presenceUnknownWarning'       : 'Este usuário pode estar desconectado. N?o é possível determinar o status.',
		...
		'tooltipAdministration'	: 'Administra??o da sala',
		...
		'errorMembersOnly': 'Você n?o pode participar da sala "%s":  privilégios insuficientes.',
		'errorMaxOccupantsReached': 'Você n?o pode participar da sala "%s": muitos participantes.',

		'antiSpamMessage' : 'Por favor, n?o envie spam. Você foi bloqueado temporariamente.'
	},
	'ru' : {
		'status': 'Статус: %s',
	...
	'ca': {
		...
		'tooltipAutoscroll'     : 'Despla?ament automàtic',
